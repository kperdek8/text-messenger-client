defmodule TextMessengerClient.MixProject do
  use Mix.Project

  def project do
    [
      app: :text_messenger_client,
      version: "0.1.0",
      elixir: "~> 1.14",
  ...
  def application do
    [
      mod: {TextMessengerClient.Application, []},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind text_messenger_client", "esbuild text_messenger_client"],
      "assets.deploy": [
